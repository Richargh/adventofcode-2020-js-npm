...
describe("count the passwords that satisfy corporate policy", function () {
    ...
    describe("does password have between min and max letters", function () {
        it("password has one 'a;  and is therefore valid", function () {
            ...
            // act
            const result = isPasswordValid02a(passwordAndPolicy);

            // assert
            expect(result).to.equal(true);
        });

        it("password has less than ten 'a' and is therefore invalid", function () {
            // arrange
            const passwordAndPolicy = { policy: {letter: "a", min: 10, max: 20}, password: "abcde"};
        ...
        it("password has no 'a' and is therefore invalid", function () {
            // arrange
            const passwordAndPolicy = { policy: {letter: "a", min: 1, max: 20}, password: "bcdefgh"};
    ...
    describe("count passwords that have between min and max letters", function () {
        ...
        it("task example", function () {
            ...
            // act
            const result = task02a(passwords);
        ...
        it("full task example", function () {
            // act
            const result = task02a(fullPasswords);
...
const fullPasswords = `6-10 p: ctpppjmdpppppp
