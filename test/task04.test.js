...
byr:1937 iyr:2017 cid:147 hgt:183cm`;
        ...
        it("can extract two passports", function () {
            // arrange
            const text = `ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm
...
hcl:#cfa07d byr:1929`;
        ...
        it("can extract multi-multi-line passports", function () {
            // arrange
            const text = `hcl:#ae17e1 iyr:2013
eyr:2024
...
byr:1937 iyr:2017 cid:147 hgt:183cm`;
            ...
            // act
            const result = task04a(text);

            // assert
            expect(result).to.equal(1);
        });

        it("count is 0, because the given passport is missing hgt field", function () {
            // arrange
            const text = `iyr:2013 ecl:amb cid:350 eyr:2023 pid:028048884
hcl:#cfa07d byr:1929`;
        ...
        it("count is 1, because the given passport is only missing the optional field cid", function () {
            // arrange
            const text = `hcl:#ae17e1 iyr:2013
eyr:2024
ecl:brn pid:760753108 byr:1931
hgt:179cm`;
        ...
        it("count is 0, because the given passport is missing the optional field cid but also the required field byr", function () {
            // arrange
            const text = `hcl:#cfa07d eyr:2025 pid:166559648
iyr:2011 ecl:brn hgt:59in`;
        ...
        it("batch example", function () {
            // arrange

            // act
            const result = task04a(batch);
        ...
        it("full batch example", function () {
            ...
            // act
            const result = task04a(fullBatch);
...
const fullBatch = `iyr:2015 cid:189 ecl:oth byr:1947 hcl:#6c4ab1 eyr:2026
hgt:174cm
pid:526744288
