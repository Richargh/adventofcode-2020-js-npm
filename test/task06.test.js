...
describe("custom customs", function () {
    describe("extract group answers", function () {
        it("example0", function () {
            ...
            // act
            const result = extractGroupAnswers(shortFormAnswers);
    ...
    describe("sum of group answers that anyone said yes to", function () {
        it("short form", function () {
            // arrange

            // act
            const result = task06a(shortFormAnswers);
        ...
        it("full form", function () {
            ...
            // act
            const result = task06a(fullFormAnswers);
...
const fullFormAnswers = `wzaopvscxknyjtiul
belforsgdhuvmwc
