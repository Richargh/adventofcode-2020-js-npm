...
const {task07a, extractAllBagRules} = require("../src/task07");

describe("handy haversacks", function () {
    describe("extract rules", function () {
        it("can extract single rule for one bag", function () {
            // arrange

            // act
            const result = extractAllBagRules(`bright white bags contain 1 shiny gold bag.`);
        ...
        it("can extract two rules for one bag", function () {
            // arrange

            // act
            const result = extractAllBagRules(`light red bags contain 1 bright white bag, 2 muted yellow bags.`);
        ...
        it("can extract no rule for one bag", function () {
            // arrange

            // act
            const result = extractAllBagRules(`faded blue bags contain no other bags.`);
        ...
        it("can extract two bags and their rules", function () {
            // arrange

            // act
            const result = extractAllBagRules(`dark orange bags contain 3 bright white bags, 4 muted yellow bags.
bright white bags contain 1 shiny gold bag.`);
        ...
        it("can extract short rules", function () {
            // arrange

            // act
            const result = extractAllBagRules(shortRules);
    ...
    describe("how many different bag colors would be valid for the bag", function () {
        it("short form", function () {
            // arrange

            // act
            const result = task07a("shiny gold", shortRules);
        ...
        it("full form", function () {
            ...
            // act
            const result = task07a("shiny gold", fullRules);
...
const shortRules = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
const fullRules = `striped tan bags contain 2 light silver bags, 1 drab black bag, 2 clear tan bags, 2 mirrored tan bags.
